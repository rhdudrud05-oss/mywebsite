...
with st.expander("📋 사용된 SQL 및 인사이트"):
    ...
    2026년 초에도 전월 대비 진폭이 큰 불안정한 흐름을 보이고 있습니다.
    </div>
    """, unsafe_allow_html=True)
...
with col_left:
    ...
    with st.expander("📋 SQL 및 인사이트"):
        ...
        <b>서울은 유일하게 기준선(100) 이하</b>로 하락했습니다.
        탈제조업화가 빠르게 진행 중임을 보여줍니다.
        </div>
        """, unsafe_allow_html=True)
...
with col_right:
    ...
    with st.expander("📋 SQL 및 인사이트"):
        ...
        <b>고용 회복 없는 생산 지표 회복</b> — 고용 없는 성장의 구조화를 시사합니다.
        </div>
        """, unsafe_allow_html=True)
...
with st.expander("📋 SQL 및 인사이트"):
    ...
    <div class="insight-box">
    💡 <b>인사이트:</b> 전기기기(반도체 포함), 자동차, 기계류가 수출 3대 품목입니다.
    반면 <b>광물성연료는 무역수지 최대 적자 품목</b>으로 에너지 수입 의존도가 수지 구조를 취약하게 만듭니다.
    </div>
    """, unsafe_allow_html=True)
...
with st.expander("📋 SQL 및 인사이트"):
    ...
    <div class="insight-box">
    💡 <b>인사이트:</b> 흑자 품목은 전기기기, 자동차, 선박 등 고부가 제조업에 집중.
    <b>에너지·원자재 의존이 제조업 흑자를 상쇄하는 구조</b>가 확인됩니다.
    </div>
    """, unsafe_allow_html=True)
