...
💡 <b>인사이트:</b> 전국 제조업 생산지수는 2022년 상반기에 약 120까지 올라갔다. 그러나 2023년에 100~103으로 약 15% 떨어졌다. 이는 전 세계 반도체 수요가 급감하고, 코로나 이후 중국 경기가 기대만큼 살아나지 않은 게 주요 원인이었다. 2024년부터 조금씩 회복됐지만 2026년 현재도 2022년 수준을 되찾지 못하고 있고, 월별 등락도 커서 아직 불안정한 흐름이 이어지고 있다. 이번 침체가 일시적인 것이 아니라 장기적인 구조 문제일 수 있음을 보여준다.
</div>
""", unsafe_allow_html=True)
...
with col_right:
    ...
    <div class="insight-box">
    💡 <b>인사이트:</b> 제조업 일자리는 2022년 약 4,525천 명을 정점으로 2025년 하반기에 4,364천 명까지 161천 명이 줄었다. 같은 기간에 생산지수는 어느 정도 회복되었지만 고용은 따라오지 못한 모습이다. 공장 자동화나 AI의 도입으로 사람 대신 기계가 그 자리를 채우면서, 경기가 좋아져도 일자리는 돌아오지 않는 구조가 됐다.
    </div>
    """, unsafe_allow_html=True)
...
<div class="insight-box">
💡 <b>인사이트:</b> 전기기기, 자동차, 선박에서 흑자를 내지만, 원유와 천연가스 수입에서 큰 적자가 나고 있다. 제조업에서 아무리 흑자를 내도 에너지 가격이 오르면 금방 상쇄되는 구조로 2022년 러시아-우크라이나 전쟁 때에도 무역적자로 전환됐다. 에너지 자립 없이는 제조업 흑자도 언제든 위협을 받을 수 있다는 게 핵심 위기이다.
</div>
""", unsafe_allow_html=True)
